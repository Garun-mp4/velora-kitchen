...
export function AboutPage() {
  return <>
    ...
    <InnerHero eyebrow="О VELORA" title="Красиво. Продумано. Индивидуально. Предсказуемо." text="Мы рассматриваем кухню и встроенную мебель как часть архитектуры дома — не как набор отдельных предметов." image="/assets/images/03-intro-open-plan-interior.webp" imageAlt="Цельный интерьер VELORA" />
